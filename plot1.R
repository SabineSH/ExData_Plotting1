...
hist(epc_feb12$GlobalActivePower, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
## copy my plot to a PNG file
dev.copy(png,file="C:/Sabine/Coursera Exploratory Data Analysis/Assignment 1/plot1.png",width = 480, height = 480)
